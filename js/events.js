...
export function initEvents({ onMenuAction, onCloseCredits, onBackMenu, onSelectByIndex, onScrollToIndex, onNavigate, updateMenuSelection }) {
    document.addEventListener('keydown',e=>{
        if(state.currentScreen==='title'){
            ...
            if(document.activeElement===searchInput){
                if(e.key==='Enter'&&state.filteredList.length){
                    e.preventDefault();
